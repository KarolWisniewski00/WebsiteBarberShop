                ...
                <div className="px-6 py-12 md:px-12 text-gray-800 text-center lg:text-left">
                    <div className="container mx-auto xl:px-32">
                        <div className="grid lg:grid-cols-4 gap-12 flex items-center">
                            <div className="mt-12 lg:mt-0 col-span-2 bg-black/50 p-10 flex flex-col h-full">
                                <iframe className="w-full m-3" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d156389.28877446154!2d20.774135358147948!3d52.2328000976016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471ecc669a869f01%3A0x72f0be2a88ead3fc!2sWarszawa!5e0!3m2!1spl!2spl!4v1672701976023!5m2!1spl!2spl" width="500" height="400" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                <div className="text-center text-xl flex flex-col justify-center content-center ml-5">
                                    <div className="text-stone-100 py-3">ul. Przykładowa 5 10-913, Miasto</div>
                                    <a href="”tel:123456789″"><div className="text-stone-100 hover:text-stone-400 py-3">123 456 789</div></a>
                                    <a href="mailto: przykład@gmail.com"><div className="text-stone-100 hover:text-stone-400 py-3">przykład@gmail.com</div></a>
                                    <div className="py-3">
                            ...
                            <div className="mt-12 lg:mt-0 col-span-2 col-start-1 sm:col-start-3 bg-black/50 p-10 h-full flex flex-col justify-center items-center">
                                <h1 className="text-5xl font-bold mb-12 color-custom text-center">Godziny otwarcia</h1>
                                <table className="table-auto w-full">
                                    <tbody className="text-stone-100">
                                        <tr>
                                            <td>Poniedziałek</td>
                                            <td className="text-right py-3">7:00 - 21:00</td>
                                        </tr>
                                        <tr>
                                            <td>Wtorek</td>
                                            <td className="text-right py-3">7:00 - 21:00</td>
                                        ...
                                        <tr>
                                            <td>Sobota</td>
                                            <td className="text-right py-3">8:00 - 15:00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
