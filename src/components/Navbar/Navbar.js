            ...
            <nav className="bg-stone-900/50 px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <button onClick={() => setIsOpen(!isOpen)} data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 text-sm text-stone-100 rounded-lg md:hidden focus:outline-none" aria-controls="navbar-sticky" aria-expanded="false">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                        <ul className="flex flex-col p-4 mt-4 bg-transparent md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            ...
                            <li><a href="https://booksy.com/pl-pl/" className="block py-2 pl-3 pr-4 md:p-0 text-stone-100 hover:text-stone-400" aria-current="page">Rezerwacja</a></li>
                    ...
                    {(ref) => (
                        <div className="md:hidden" id="mobile-menu">
                            <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3 text-center">
                                ...
                                <a href="https://booksy.com/pl-pl/"className="text-stone-100 hover:text-stone-400 block px-3 py-2 text-base font-medium">Rezerwacja</a>
